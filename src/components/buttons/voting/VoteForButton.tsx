...
export const VoteForButton = (props: ButtonProps & any) => {
  ...
  const handleVoteFor = React.useCallback(async () => {
    ...
    toast({
      ...
      render: () => (
        <TxToast
          ...
          body='Your vote to approve the proposal has been submitted'
  ...
  return (
    ...
    >
      {isPending ? <Spinner size='xs' /> : isSuccessful ? `Approved` : text}
    </Button>
  );
};
